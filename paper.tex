...
The user get $m^d$ which is the signer's signature of the message $m$. At the same time, the signer does not know $m$ and the session key is protected. 
...
\begin{figure}[h]
	...
	\caption{The process of the refunding.}
	\label{fig:refund}
\end{figure}

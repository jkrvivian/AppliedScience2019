...
Next, session key $k$ should be exchanged between the data provider and consumers. Instead of using off-chain solution which is efficient and low-cost, we use smart contract to transfer the session key\cite{3tierDataMarket} that is easy to trace the record and prevent malicious participants to cheat others.
